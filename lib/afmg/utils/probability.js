...
import { minmax, rn } from "./numberUtils.js";
 ...
 */
export const biased = (min, max, ex) => {
 ...
 */
export const getNumberInRange = r => {
  if (typeof r !== "string") {
